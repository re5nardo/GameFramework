...
Shader "Shaders/TA/BackGround/RK_BG_Blend(Transparent)"{
Properties	{
...
//	        o.vertexColor = v.vertexColor;
	    ...
	    fixed4 frag(v2f i) : COLOR {
	            ...
	            fixed4 _Alpha_var = tex2D(_Alpha,i.texcoord1);

              	fixed node_9936 = _Alpha_var.r;	 
	            fixed3 emissive = _MainTex_var;
	            fixed3 finalColor = emissive * _MainColor * _BGColor;

	            UNITY_APPLY_FOG(i.fogCoord, finalColor);
	            return fixed4(finalColor, ( _MainTex_var.a * node_9936 * _MainColor.a));
	        }
	        ENDCG
