...
Shader "Shaders/TA/BackGround/RK_BG_SiegeField_Mark(Opaque)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				return (col*_MainColor) * mask * _BGColor * _Rim;
			}
			ENDCG
		}
	}
...
#include "UnityCG.cginc"
			...
			v2f vert(appdata v)
			{
				...
				o.uv2 = TRANSFORM_TEX(float2(_Time.y * _Speed, v.uv2.y), _MainTex);
				return o;
			}
