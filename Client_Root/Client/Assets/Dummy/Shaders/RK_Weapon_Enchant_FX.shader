...
Shader "Shaders/TA/Character/RK_Weapon_Enchant_FX" {
    Properties {
		[Header(Main)]
	...
	SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                fixed VdotN = dot(viewDirection,i.normalDir);
				...
				fixed absMainTexMask = (abs(((frac(((_Time.g*0.2)+_MainTexMask_var.r))*2.0)+(-1.0)))*_MainTexMask_var.r);
				fixed3 mainScroll = _MainTex_var.rgb*_MainTexColorIntensity.rgb*absMainTexMask;
				
                fixed3 emissive = VdotN*(subScroll+mainScroll)*i.vertexColor.rgb;
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
				...
				o.uv1 = TRANSFORM_TEX(node_8437, _SubTex);
				fixed2 node_7977 = (o.uv0+(fixed2(_SubTexUScrollSpeed,_SubTexVScrollSpeed)*_Time.g));
				o.uv2 = TRANSFORM_TEX(node_7977, _MainTex);
                return o;
            }
            ...
            fixed4 frag(VertexOutput i) : COLOR {
				...
				fixed3 mainScroll = _MainTex_var.rgb*_ScrollTex_01_var.rgb*_MainTexColorIntensity.rgb;
