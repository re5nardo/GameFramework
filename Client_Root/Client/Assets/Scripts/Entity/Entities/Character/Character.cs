...
public class Character : Entity
{
    ...
    public override void Initialize(FBS.Data.EntityType entityType, int nID, int nMasterDataID)
    {
        ...
        InitStat(new CharacterStat((int)characterMasterData.m_fHP, (int)characterMasterData.m_fMP, 1, characterMasterData.m_fMoveSpeed, characterMasterData.m_fMoveSpeed * 2, 1));
