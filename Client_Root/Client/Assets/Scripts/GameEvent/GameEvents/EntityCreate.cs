...
namespace GameEvent
{
    public class EntityCreate : IGameEvent
    {
        ...
        {
            return string.Format("{0}, EntityID : {1}, MasterDataID : {2}, EntityType : {3}, Position : {4}", base.ToString(), m_nEntityID, m_nMasterDataID, m_EntityType, m_vec3Position.ToString());
        }
    }
}
