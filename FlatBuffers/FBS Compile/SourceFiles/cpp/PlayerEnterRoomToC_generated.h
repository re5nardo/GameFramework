...
struct PlayerEnterRoomToCBuilder {
  ...
  void add_PlayerEntityID(int32_t PlayerEntityID) { fbb_.AddElement<int32_t>(PlayerEnterRoomToC::VT_PLAYERENTITYID, PlayerEntityID, 0); }
  ...
  flatbuffers::Offset<PlayerEnterRoomToC> Finish() {
    auto o = flatbuffers::Offset<PlayerEnterRoomToC>(fbb_.EndTable(start_, 3));
    return o;
  }
};
...
inline flatbuffers::Offset<PlayerEnterRoomToC> CreatePlayerEnterRoomToCDirect(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreatePlayerEnterRoomToC(_fbb, PlayerIndex, PlayerEntityID, CharacterID ? _fbb.CreateString(CharacterID) : 0);
}
