...
#ifndef FLATBUFFERS_GENERATED_POSITION_FBS_PLAYERINPUT_H_
#define FLATBUFFERS_GENERATED_POSITION_FBS_PLAYERINPUT_H_
...
struct PositionBuilder {
  ...
  void add_Pos(const FBS::Data::Vector3 *Pos) { fbb_.AddStruct(Position::VT_POS, Pos); }
  ...
  flatbuffers::Offset<Position> Finish() {
    auto o = flatbuffers::Offset<Position>(fbb_.EndTable(start_, 2));
    return o;
  }
};
...
#endif  // FLATBUFFERS_GENERATED_POSITION_FBS_PLAYERINPUT_H_
