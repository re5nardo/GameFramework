...
#ifndef FLATBUFFERS_GENERATED_WORLDSNAPSHOTTOC_FBS_H_
#define FLATBUFFERS_GENERATED_WORLDSNAPSHOTTOC_FBS_H_
...
struct EntityState FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const FBS::Data::Vector3 *Position() const { return GetStruct<const FBS::Data::Vector3 *>(VT_POSITION); }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<FBS::Data::Vector3>(verifier, VT_POSITION) &&
...
struct EntityStateBuilder {
  ...
  void add_Position(const FBS::Data::Vector3 *Position) { fbb_.AddStruct(EntityState::VT_POSITION, Position); }
  void add_Rotation(const FBS::Data::Vector3 *Rotation) { fbb_.AddStruct(EntityState::VT_ROTATION, Rotation); }
...
inline flatbuffers::Offset<EntityState> CreateEntityState(flatbuffers::FlatBufferBuilder &_fbb,
    ...
    const FBS::Data::Vector3 *Position = 0,
...
struct WorldSnapShotToC FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum {
    VT_TICK = 4,
    VT_TIME = 6,
    VT_ENTITYSTATES = 8
...
struct WorldSnapShotToCBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_Tick(int32_t Tick) { fbb_.AddElement<int32_t>(WorldSnapShotToC::VT_TICK, Tick, 0); }
  void add_Time(float Time) { fbb_.AddElement<float>(WorldSnapShotToC::VT_TIME, Time, 0.0f); }
  void add_EntityStates(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<EntityState>>> EntityStates) { fbb_.AddOffset(WorldSnapShotToC::VT_ENTITYSTATES, EntityStates); }
  WorldSnapShotToCBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
  WorldSnapShotToCBuilder &operator=(const WorldSnapShotToCBuilder &);
  flatbuffers::Offset<WorldSnapShotToC> Finish() {
    auto o = flatbuffers::Offset<WorldSnapShotToC>(fbb_.EndTable(start_, 3));
    return o;
  }
};

inline flatbuffers::Offset<WorldSnapShotToC> CreateWorldSnapShotToC(flatbuffers::FlatBufferBuilder &_fbb,
    int32_t Tick = 0,
    float Time = 0.0f,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<EntityState>>> EntityStates = 0) {
  WorldSnapShotToCBuilder builder_(_fbb);
...
inline flatbuffers::Offset<WorldSnapShotToC> CreateWorldSnapShotToCDirect(flatbuffers::FlatBufferBuilder &_fbb,
    int32_t Tick = 0,
    float Time = 0.0f,
    const std::vector<flatbuffers::Offset<EntityState>> *EntityStates = nullptr) {
  return CreateWorldSnapShotToC(_fbb, Tick, Time, EntityStates ? _fbb.CreateVector<flatbuffers::Offset<EntityState>>(*EntityStates) : 0);
}

}  // namespace FBS

#endif  // FLATBUFFERS_GENERATED_WORLDSNAPSHOTTOC_FBS_H_
