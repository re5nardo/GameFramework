...
public sealed class EntityState : Table {
  ...
  public FBSData.Vector3 Position { get { return GetPosition(new FBSData.Vector3()); } }
  public FBSData.Vector3 GetPosition(FBSData.Vector3 obj) { int o = __offset(6); return o != 0 ? obj.__init(o + bb_pos, bb) : null; }
  public FBSData.Vector3 Rotation { get { return GetRotation(new FBSData.Vector3()); } }
  public FBSData.Vector3 GetRotation(FBSData.Vector3 obj) { int o = __offset(8); return o != 0 ? obj.__init(o + bb_pos, bb) : null; }
  ...
  public static void AddPosition(FlatBufferBuilder builder, Offset<FBSData.Vector3> PositionOffset) { builder.AddStruct(1, PositionOffset.Value, 0); }
  public static void AddRotation(FlatBufferBuilder builder, Offset<FBSData.Vector3> RotationOffset) { builder.AddStruct(2, RotationOffset.Value, 0); }
