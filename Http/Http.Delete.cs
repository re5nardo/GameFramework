...
namespace GameFramework
{
    ...
    {
        public static HttpRequestContainer<TResponse> Delete<TResponse>(string apiEndpoint, Action<TResponse> onResult = null, Action<string> onError = null,
            Dictionary<string, string> requestHeaders = null, Dictionary<string, string> queryString = null, ServerSettings apiSettings = null)
        {
            ...
            UnityHttp.Delete(reqContainer.uri, reqContainer.requestHeaders, reqContainer.OnResponse, reqContainer.OnError);
