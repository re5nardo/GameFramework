...
#include "../../../FBSFiles/CreateRoomToL_generated.h"
...
const char* CreateRoomToL::Serialize(int* pLength)
{
	...
	FBS::CreateRoomToLBuilder data_builder(m_Builder);
...
{
	auto data = flatbuffers::GetRoot<FBS::CreateRoomToL>((const void*)pChar);
