...
BlobAI::BlobAI(BaeGameRoom* pGameRoom, int nMasterDataID, long long lStartTime) : ICharacterAI(pGameRoom, nMasterDataID, lStartTime)
{
}
...
void BlobAI::UpdateBody(long long lUpdateTime)
{
...
void BlobAI::SetData(btVector3& vec3StartPosition, btVector3& vec3StartRotation)
{
