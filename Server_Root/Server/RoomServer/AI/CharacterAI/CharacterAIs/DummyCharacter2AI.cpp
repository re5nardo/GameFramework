#include "stdafx.h"
#include "DummyCharacter2AI.h"
#include "../../../Entity/Entities/Character/Character.h"
#include "../../../Game/BaeGameRoom.h"

DummyCharacter2AI::DummyCharacter2AI(BaeGameRoom* pGameRoom, int nMasterDataID, long long lStartTime) : ICharacterAI(pGameRoom, nMasterDataID, lStartTime)
{
}

DummyCharacter2AI::~DummyCharacter2AI()
{
}

void DummyCharacter2AI::UpdateBody(long long lUpdateTime)
{
	/*float fFireTime = 0;
...
void DummyCharacter2AI::SetData(btVector3& vec3StartPosition, btVector3& vec3StartRotation)
{
