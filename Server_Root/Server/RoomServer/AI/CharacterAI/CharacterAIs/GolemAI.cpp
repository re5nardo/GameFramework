...
GolemAI::GolemAI(BaeGameRoom* pGameRoom, int nMasterDataID, long long lStartTime) : ICharacterAI(pGameRoom, nMasterDataID, lStartTime)
{
}
...
void GolemAI::UpdateBody(long long lUpdateTime)
{
...
void GolemAI::SetData(btVector3& vec3StartPosition, btVector3& vec3StartRotation, btVector3& vec3DestPosition)
{
