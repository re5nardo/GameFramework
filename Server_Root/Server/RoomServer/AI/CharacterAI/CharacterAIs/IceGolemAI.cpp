...
IceGolemAI::IceGolemAI(BaeGameRoom* pGameRoom, int nMasterDataID, long long lStartTime) : ICharacterAI(pGameRoom, nMasterDataID, lStartTime)
{
}

IceGolemAI::~IceGolemAI()
{
}

void IceGolemAI::UpdateBody(long long lUpdateTime)
{
...
void IceGolemAI::SetData(btVector3& vec3StartPosition, btVector3& vec3StartRotation, btVector3& vec3DestPosition)
{
