...
IceQueenMaidAI::IceQueenMaidAI(BaeGameRoom* pGameRoom, int nMasterDataID, long long lStartTime) : ICharacterAI(pGameRoom, nMasterDataID, lStartTime)
{
}

IceQueenMaidAI::~IceQueenMaidAI()
{
}

void IceQueenMaidAI::UpdateBody(long long lUpdateTime)
{
	float spawntime = 1;
	float cooltime = 5;
...
void IceQueenMaidAI::SetData(btVector3& vec3StartPosition, btVector3& vec3StartRotation)
{
