...
SkullArcherAI::SkullArcherAI(BaeGameRoom* pGameRoom, int nMasterDataID, long long lStartTime) : ICharacterAI(pGameRoom, nMasterDataID, lStartTime)
{
}

SkullArcherAI::~SkullArcherAI()
{
}

void SkullArcherAI::UpdateBody(long long lUpdateTime)
{
...
void SkullArcherAI::SetData(btVector3& vec3StartPosition, btVector3& vec3StartRotation)
{
