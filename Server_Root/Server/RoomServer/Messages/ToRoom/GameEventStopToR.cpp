...
#include "../../../FBSFiles/GameEventStopToR_generated.h"
...
{
	FBS::Data::Vector3 pos(m_vec3Pos.x(), m_vec3Pos.y(), m_vec3Pos.z());

	FBS::GameEventStopToRBuilder data_builder(m_Builder);
...
{
	auto data = flatbuffers::GetRoot<FBS::GameEventStopToR>((const void*)pChar);
